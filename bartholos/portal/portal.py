...
import bartholos
from bartholos.utils.utils import import_from_module, callables_from_module
...
class Core:
    ...
    async def setup(self):
        ...
        for module in bartholos.SETTINGS.PORTAL_EVENT_HANDLER_MODULES:
            for k, v in callables_from_module(module).items():
                bartholos.EVENTS[k] = v
